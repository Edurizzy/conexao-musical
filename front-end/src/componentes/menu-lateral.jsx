...
export default function MenuLateral({ children }) {
    ...
    const opçõesLíderBanda = [
        { label: "Página Inicial", command: () => navegar("/pagina-inicial") },
        {
            label: "Menu", items: [
                ...
                { label: "Cadastrar LíderBanda", command: () => navegar("/cadastrar-líder_banda") },
    ...
    function opçõesMenu() {
        switch (usuárioLogado.perfil) {
            case "líder_banda": return opçõesLíderBanda;
            case "músico": return opçõesMúsico;
            default: return;
        }
    };
